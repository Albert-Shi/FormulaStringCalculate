package com.formula.calc;

import com.formula.calc.operator.Operator;
import com.formula.calc.operator.OperatorFactory;
...
public class Calculator {
    ...
    private String dealStr(String exp) {
    ...
    public static void main(String[] args) {
        ...
        String a = calculator.dealStr(exp);
